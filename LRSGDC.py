...
class LRSGDC(Optimizer):
    """ Revised based on the official implementation of SGD optimizer
    """

    def __init__(self, params, lr, lambda_w, momentum=0, dampening=0,
        ...
        super(LRSGDC, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(LRSGDC, self).__setstate__(state)

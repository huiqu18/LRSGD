...
class LRSGDR(Optimizer):
    """ Revised based on the official implementation of SGD optimizer
    """

    def __init__(self, params, lr, lambda_w, momentum=0, weight_decay=0,
        ...
        super(LRSGDR, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(LRSGDR, self).__setstate__(state)
